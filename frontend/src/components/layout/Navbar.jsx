            ...
            {isAuthenticated && user ? (
              <div className="relative">
                ...
                >
                  ...
                  <span className="hidden sm:block text-xs font-body text-on-surface-variant max-w-[80px] truncate">
                    {user.name?.split(' ')[0]}
                  </span>
                </button>
                  ...
                  {userMenuOpen && (
                    <>
                      ...
                      <motion.div
                        ...
                        className="absolute right-0 top-12 w-52 bg-surface-2 border border-white/10 rounded-m3-lg shadow-m3-4 overflow-hidden z-50"
                      >
            ...
            >
              ...
              <div className="px-4 py-2">
                <select
                  value={currency}
                  onChange={(e) => setCurrency(e.target.value)}
                  className="w-full bg-surface-2 border border-outline/30 rounded-m3-md px-2 py-1.5 text-xs font-mono text-on-surface-variant focus:outline-none"
                >
